...
#include "Vehicle/MovementComponents/BaseCarlaMovementComponent.h"
...
void UBaseCarlaMovementComponent::EnableUE4VehiclePhysics(bool bResetVelocity)
{
	...
	CarlaVehicle->GetMesh()->PhysicsTransformUpdateMode =
	...
	CarlaVehicle->GetMesh()->SetCollisionResponseToChannel(ECollisionChannel::ECC_WorldStatic,
