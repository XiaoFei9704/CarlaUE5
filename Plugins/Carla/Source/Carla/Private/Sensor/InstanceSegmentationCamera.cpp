...
#include "Sensor/InstanceSegmentationCamera.h"
...
void AInstanceSegmentationCamera::SetUpSceneCaptureComponent(USceneCaptureComponent2D& SceneCapture)
{
	...
	// TaggedComponent detects this and sets view relevance for proxy material
	...
	GetObjectsOfClass(UTaggedComponent::StaticClass(), TaggedComponents, false, EObjectFlags::RF_ClassDefaultObject,
