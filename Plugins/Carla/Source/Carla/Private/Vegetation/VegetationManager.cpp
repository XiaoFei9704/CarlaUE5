...
/********** POOLED ACTOR STRUCT *************************************************/
/********************************************************************************/
void FPooledActor::EnableActor(const FTransform& Transform, int32 NewIndex,
	...
	TArray<FPooledActor>& Pool)
{
	...
	for (FPooledActor& PooledActor : Pool)
	{
		...
		PooledActor.Actor->SetActorLocationAndRotation(Transform.GetLocation(), Transform.Rotator(), true, nullptr,
